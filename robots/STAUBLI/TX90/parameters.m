...
%   TX90.
%
%   Authors: DANIEL VICO VACA
%            JUAN CARLOS GALIANO GONZÁLEZ
%            RUBEN MARTÍNEZ SERRANO   
%                      
%   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.path = 'robots/staubli/TX90';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3)+pi/2 q(4) q(5) q(6)]';
robot.DH.d='[0.478 0.05 0 0.425 0 0.1]';
robot.DH.a='[0.05 0.425 0 0 0 0]';
robot.DH.alpha= '[-pi/2 0 pi/2 -pi/2 pi/2 0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_tx90(robot, T)';
...
robot.linear_velmax = 5; %m/s, unavailable from datasheet
...
robot.graphical.color = [250 25 0]./255;
%for transparency
...
%link masses (kg)
robot.dynamics.masses=[34.73 39.27 15.13 21.25 0.42 0.03];
