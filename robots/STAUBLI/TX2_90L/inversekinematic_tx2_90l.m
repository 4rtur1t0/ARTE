...
function q = inversekinematic_tx2_90l(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_tx_290l: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
