%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_TX200(robot, T)	
...
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_TX200 returns 8 possible solutions, thus,
...
function q = inversekinematic_TX200(robot, T)
...
for i=1:2:size(q,2),
    ...
    %1qtemp = solve_spherical_wrist2(robot, q(:,i), T, -1, 'algebraic'); %wrist down
    qtemp(4:6)=normalize(qtemp(4:6));
    q(:,i+1)=qtemp;
end
...
% % STÄBLI TX200--> use solve_spherical_wrist2
