...
%   Solves the inverse kinematic problem for the STAUBLI TX200 robot
%   where:
...
%
%   Author:    Manuel Esquer Cerezo
%
%               Taken the inversekinematic_irb140 function as a basis         
%               Universitas Miguel Hernandez in Elche, SPAIN.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_TX200: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
