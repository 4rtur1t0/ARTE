...
%   TX200L.
%
%   Author: Carlos Pardo Pla, Ricardo Ortuño Garcia, Daniel Garcia Lopez.
%   email: arturo.gil@umh.es date:   11/12/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  
...
robot.path = 'robots/staubli/TX200L';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3)+pi/2 q(4) q(5) q(6)]';
robot.DH.d='[0.642 0 0 1.2 0 0.194]';
robot.DH.a='[0.25 0.950 0 0 0 0]';
robot.DH.alpha= '[-pi/2 0 pi/2 -pi/2 pi/2 0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_tx200l(robot, T)';
...
robot.velmax = [deg2rad(160); %Axis 1, rad/s
                deg2rad(160); %Axis 2, rad/s
                deg2rad(160); %Axis 3, rad/s
                deg2rad(260); %Axis 4, rad/s
                deg2rad(260); %Axis 5, rad/s
