...
%
%   Author: David J. Rold�n. Universidad Miguel Hernandez de Elche. 
...
robot.inversekinematic_fn = 'inverse_kinematics_ur10_practical(robot, T, q)';
...
robot.parameters.stop_iterations=5000;
