...
%   SAWYER robot from Rethink Robotics.
%
%   Author: Arturo Gil. Universidad Miguel Hernandez de Elche. 
%   email: arturo.gil@umh.es date:   19/07/2018
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.inversekinematic_fn = 'inverse_kinematics_sawyer_practical(robot, T, q)';
...
robot.maxangle =[-pi pi; %Axis 1, minimum, maximum
                ...
                deg2rad(-400) deg2rad(400) ]; %Axis 7: Really Unlimited to (800� default)
...
robot.graphical.color = [255 42 51]./255;
%for transparency
...
robot.parameters.stop_iterations=1000;
