...
%
%   robot.environment = load_robot('equipment','conveyor_belt1')
%
...
robot.T0 = [1 0 0 1.5;0 1 0 -2.2;0 0 1 0;0 0 0 1];
...
robot.graphical.color = [80 80 80]./255;
%for transparency
