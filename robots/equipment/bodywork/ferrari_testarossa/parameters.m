...
%   ferrari Testarossa bodywork. 
%   The bodywork is intended to be used is intended to be used as a working
%   environment for robots. Please load it as:
%
%   robot.environment = load_robot('environment','bodywork/ferrari_testarossa')
%
...
robot.name= 'CAR BODYWORK: Ferrari Testarossa';
