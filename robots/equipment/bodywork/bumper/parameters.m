...
%   bumper for a car. The bumper is intended to be used is intended to be used as a working
%   environment for robots. Please load it as:
%
%   robot.piece = load_robot
%
...
robot.graphical.color = [180 180 8]./255;
%for transparency
