...
%
%   robot.environment = load_robot('equipment','aluminum_plate1')
%
...
robot.T0 = [1 0 0 1.8;0 1 0 -0.6;0 0 1 0.8;0 0 0 1];
...
robot.axis=[1 4 -0.75 0.75 0.5 1];
%read graphics files
