%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   PARAMETERS Returns a data structure containing the parameters of a car
%   bodywork. The bodywork is intended to be used is intended to be used as a working
%   environment for robots. Please load it as:
%
%   robot.environment = load_robot('environment','bodywork')
%
%   Author: María Tuesta San Miguel, Héctor Barreras Almarcha y Adrián Maleno Vicaíno. Universidad Miguel Hernández de Elche. 
%    date:   15/12/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.graphical.color = [80 80 85]./255;
%for transparency
