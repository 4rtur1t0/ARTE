...
robot.name= 'Epson_Prosix_C8L_A901S';
robot.path = 'robots/Epson/Prosix_C8L_A901S';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='[0.472 0 0 0.4 0 0.080]';
robot.DH.a='[0.1 0.430 0 0 0 0]';
robot.DH.alpha= '[-pi/2 0 -pi/2 pi/2 -pi/2 0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_Prosix_C8L_A901S(robot, T)';
...
robot.maxangle =[-pi pi; %Axis 1, minimum, maximum
                deg2rad(-156) deg2rad(65); %Axis 2, minimum, maximum
