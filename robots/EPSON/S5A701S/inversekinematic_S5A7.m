%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_S5A7(robot, T)	
%   Solves the inverse kinematic problem for the EPSON S5A701 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC__S5A7 returns 8 possible solutions, thus,
...
function q = inversekinematic_S5A7(robot, T)
