function q = inversekinematic_EPSON_C8L(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_Epson_C8L: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
