...
robot.name= 'abb_IRB_4600_40_255';
...
robot.inversekinematic_fn = 'inversekinematic_IRB_4600_40_255(robot, T)';
...
robot.maxangle =[deg2rad(-180) deg2rad(180); %Axis 1, minimum, maximum
                ...
                deg2rad(-400) deg2rad(400); %Axis 4: Unlimited (400ï¿½ default)
                deg2rad(-125) deg2rad(120); %Axis 5
                deg2rad(-400) deg2rad(400)]; %Axis 6: Unlimited (800ï¿½ default)
...
%link masses (kg)
robot.dynamics.masses=[30 35 15 15 5 2];
