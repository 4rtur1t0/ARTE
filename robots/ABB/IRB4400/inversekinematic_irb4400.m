...
%this robot, due to physical restrictions does allow only 2
%possible solutions (called wrist up and wrist down)
q=zeros(6,1);
...
%q2(2) = pi/2 + beta - gamma; %imposible este caso 

q2(1) = pi/2 - beta - gamma; %elbow up, only this solution
%is feasible in this robot
