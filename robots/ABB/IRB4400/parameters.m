...
robot.name= 'ABB_IRB4400';

%Path where everything is stored for this robot


robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='[0.680 0 0 0.88 0 0.14]';
robot.DH.a='[0.2 0.890 0.15 0 0 0]';
robot.DH.alpha= '[-pi/2 0 -pi/2 pi/2 -pi/2 0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_irb4400(robot, T)';
...
robot.maxangle =[deg2rad(-165) deg2rad(165);
    %-pi pi; %Axis 1, minimum, maximum
                deg2rad(-70) deg2rad(95); %Axis 2, minimum, maximum
                deg2rad(-60) deg2rad(65); %Axis 3
