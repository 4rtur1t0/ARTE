%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB6650S_90_390(robot, T)	
...
function q = inversekinematic_irb6650S_90_390(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb6650_90_390: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
