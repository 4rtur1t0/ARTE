...
%   ABB IRB910INV (scara inverted version).
%
%   Author: Arturo Gil. Universidad Miguel Hernandez de Elche. 
%   email: arturo.gil@umh.es date:   09/01/2023
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.name= 'ABB_IRB910_INV';
robot.DH.theta= '[q(1) q(2) 0 q(4)]';
robot.DH.d='[0.228 0 q(3)+0.196 0]';
robot.DH.a='[-0.175 0.175 0 0]';
robot.DH.alpha= '[pi pi 0 0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_irb910inv(robot, T)';
...
% end effector's maximum velocity
...
robot.axis=[-0.5 0.5 -0.5 0.5 0 0.75];
%read graphics files
