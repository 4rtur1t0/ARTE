...
robot.name= 'ABB_IRB7600_500_230';

%Path where everything is stored for this robot
robot.path = 'robots/abb/IRB7600_500_230';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='[0.78 0 0 0.806 0 0.25]';
...
robot.inversekinematic_fn = 'inversekinematic_irb7600_500_230(robot, T)';
