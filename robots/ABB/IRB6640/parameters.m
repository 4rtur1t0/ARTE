...
%   ABB IRB6640.
%
%   Authors: Vicente Quiles, Andres Lopez and Pablo Valero  . Universidad Miguel Hernández de Elche. 
%   email:  date:   27/11/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.name= 'ABB_IRB6640';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='[0.780 0 0 1.142 0 0.2]';
robot.DH.a='[0.320 1.075 0.2 0 0 0]';
robot.DH.alpha= '[-pi/2 0 -pi/2 pi/2 -pi/2 0]';

robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_irb6640(robot, T)';
