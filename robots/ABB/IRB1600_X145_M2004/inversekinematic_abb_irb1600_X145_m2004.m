%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB1600_(robot, T)	
...
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_IRB1600 returns 8 possible solutions, thus,
...
function [q, valid] = inversekinematic_abb_irb1600_X145_m2004(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb1600_X145: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
