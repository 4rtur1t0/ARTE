%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB52(robot, T)	
...
% Nos hemos basado en la cinem�tica inversa del IRB140, pues ambos robots
% son muy parecidos, y hemos le�do la resoluci�n de la cinem�tica inversa y
% nos vale para nuestro robot.
function [q] = inversekinematic_irb52(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb52: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
