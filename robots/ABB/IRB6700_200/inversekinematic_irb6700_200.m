%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB6700_200(robot, T)	
...
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_IRB6640 returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   abb=load_robot('ABB', 'IRB6700_200');
%   q = [0 0 0 0 0 0];	
...
function q = inversekinematic_irb6700_200(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb6620: the point is not reachable for this configuration, imaginary solutions'); 
