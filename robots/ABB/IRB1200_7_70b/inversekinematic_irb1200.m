%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB1200-7/0.7(robot, T)	
%   Solves the inverse kinematic problem for the ABB IRB 1200-7/0.7 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_IRB1200-7/0.7 returns 8 possible solutions, thus,
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb1200: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
