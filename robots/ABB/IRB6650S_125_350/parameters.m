...
robot.name= 'ABB_IRB6650S-125/350';

%Path where everything is stored for this robot
robot.path = 'robots/abb/IRB6650S-125/350';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='[0.630 0 0 1.592 0 0.2]';
...
robot.inversekinematic_fn = 'inversekinematic_irb6650S_125_350(robot, T)';
