...
for i=1:2:size(q,2),
    %Use solve_spherical_wrist2 for the ABB robots, since the special
    %initial orientation needs to be matched
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_irb1600_6-120: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
