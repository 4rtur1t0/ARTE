%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_IRB8700_800_350(robot, T)	
%   Solves the inverse kinematic problem for the ABB IRB 7600_150 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_IRB8700_800_350 returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   abb=load_robot('abb', 'IRB8700_800_350');
%   q = [0 0 0 0 0 0];	
...
function q = inversekinematic_IRB8700_800_350(robot, T)
