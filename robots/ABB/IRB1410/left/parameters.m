...
%   ABB IRB140.
%
%   Authors: Vicente Román Erades
%	     Alejandro González Delgado
%	     Javier Andrés Pérez
%
% Universidad Miguel Hernandez de Elche. 
%   email: vicentererades@gmail.com 16/12/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.DH.d='[0.465 0 0 0.720 0 0.075]';
robot.DH.a='[0.150 0.600 0.120 0 0 0]';
...
robot.maxangle =[deg2rad(-170) deg2rad(170); %Axis 1, minimum, maximum
                deg2rad(-70) deg2rad(70); %Axis 2, minimum, maximum
                deg2rad(-250) deg2rad(280); %Axis 3
                deg2rad(-200) deg2rad(200); %Axis 4: Unlimited (400ï¿½ default)
                deg2rad(-115) deg2rad(115); %Axis 5
                deg2rad(-300) deg2rad(300)]; %Axis 6: Really Unlimited to (800ï¿½ default)
