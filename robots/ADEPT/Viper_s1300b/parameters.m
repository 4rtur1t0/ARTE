...
%   Adept Viper_s1300.
%
%   Authors: Santiago Ferre Satoca, Javier Ferre Satoca and
...
robot.name= 'Adept_Viper_s1300';

%Path where everything is stored for this robot
robot.path = 'robots/adept/Viper_s1300';

robot.DH.theta= '[q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)]';
robot.DH.d='[0.475 0 0 0.590 0 0.084]';
robot.DH.a='[0.180 0.520 0.100 0 0 0]';
...
robot.velmax = [deg2rad(225); %Axis 1, rad/s
                deg2rad(168.75); %Axis 2, rad/s
                deg2rad(187.5); %Axis 3, rad/s
...
robot.graphical.color = [245 243 225]./255;
%for transparency
...
robot.axis=[-0.5 1 -0.5 0.5 0 1.5];
%read graphics files
