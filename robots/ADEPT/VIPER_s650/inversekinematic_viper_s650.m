%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_viper_s650(robot, T)	
%   Solves the inverse kinematic problem for the ADEPT Viper 900 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_Viper_s650 returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   >>abb=load_robot('ADEPT', 'Viper_900');
%   >>q = [0 0 0 0 0 0];	
...
function q = inversekinematic_viper_s650(robot, T)
