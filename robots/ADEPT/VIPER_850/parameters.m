...
robot.name= 'ADEPT_VIPER_850';

%Path where everything is stored for this robot
robot.path = 'robots/ADEPT/VIPER_850';

robot.DH.theta= '[q(1) q(2)+pi/2 q(3) q(4) q(5) q(6)]';
robot.DH.d='[0.335 0 0  0.405 0 0.145]';
robot.DH.a='[0.075 0.365 0.09 0 0 0]';
...
%for transparency
robot.graphical.draw_transparent=0.5;
%draw DH systems
