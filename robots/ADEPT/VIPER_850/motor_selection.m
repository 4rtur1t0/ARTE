...
robot = load_robot('ADEPT', 'VIPER_850');
echo off
...
maximum_speeds= robot.velmax';%rad/second
%maximum acceleration/deceleration for each joint
maximum_accels=[3 3 3 9 9 9]; %rad/second^2
...
%draw robot in that robot pose q
drawrobot3d(robot, q)

%START BY COMPUTING TORQUES AT G
% robot.motors.G = [186 80 100 50 20 20]
robot.motors.G = [139 10 93 74 18 4]
