...
function [q] = inversekinematic_Viper_s1700D(robot, T)
...
if ~isreal(gamma)
    disp('WARNING:inversekinematic_Viper_s1700D: the point is not reachable for this configuration, imaginary solutions'); 
    %gamma = real(gamma);
end
