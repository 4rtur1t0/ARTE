...
q0 = [0.0 -0.6 0.3 1.2 0.3 1.0 0.3]';
...
while 1  
    ...
    %qd = compute_control_action_pseudo(robot, Vref, q, qf);
    %qd = compute_control_action_non_redundant(robot, q, Vref, 3);
