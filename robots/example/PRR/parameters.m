...
robot.inversekinematic_fn = 'inversekinematic_PRR(robot, T)';
...
robot.maxangle =[0 2; %Axis 1, minimum, maximum
                -pi pi;
                -pi pi]; %Axis 3,rotational
                
             

%maximum absolute speed of each joint rad/s or m/s
robot.velmax = [1; %Axis 1, rad/s
