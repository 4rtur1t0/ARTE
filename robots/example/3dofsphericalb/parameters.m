...
robot.name='Example 3DOF spherical arm B';

%The low arm's length and the upper arm's length
robot.L1=0.3;
robot.L2=0.7; %also written in the DH, here just for clarity
...
robot.inversekinematic_fn = 'inversekinematic_3dofsphericalb(robot, T)';
