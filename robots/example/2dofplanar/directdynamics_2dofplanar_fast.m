%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Direct dynamics for the 2dof planar robot
%
%   qdd = directdynamics_2dofplanar_fast(robot, q, qd, qdd, fe)
%   
...
function qdd = directdynamics_2dofplanar_fast(robot, q, qd, tau, fe)
...
% A different way to write the equations of torque.
