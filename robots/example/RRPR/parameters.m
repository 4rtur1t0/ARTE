...
%   RRPR example arm with 4 DOF.
%
%   Author: Arturo Gil. Universidad Miguel Hernandez de Elche. 
%   email: arturo.gil@umh.es date:   03/01/2025
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.DH.theta= '[q(1) q(2)+pi/2 0 q(4)-pi/2]';
robot.DH.d='[0.5 0  q(3)   0]';
robot.DH.a='[0  0  0 0.5]';
robot.DH.alpha= '[pi/2  pi/2  -pi/2  0]';

%Jacobian matrix. Variation of (X, Y, Z) as a function of (w1, w2, w3)
robot.J='[];';
robot.name='RRPR';

robot.inversekinematic_fn = 'inversekinematics_RRPR_algebraic(robot, T)';
