...
%   email: arturo.gil@umh.es date:   03/11/2020
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%KYNEMATICS
robot.name= 'UNIMATE 1';

robot.DH.theta = '[q(1)    q(2)+pi/2    0      q(4)    q(5)]';
robot.DH.d=      '[1.0         0       q(3)     0      0.2 ]';
robot.DH.a=      '[0           0         0      0       0   ]';
robot.DH.alpha=  '[-pi/2     pi/2      -pi/2   pi/2     0 ]';
robot.J=[];
robot.name='Unimate 1';

robot.inversekinematic_fn = 'inversekinematic_uni1(robot, T)';
