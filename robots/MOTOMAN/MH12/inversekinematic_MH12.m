...
%   Solves the inverse kinematic problem for the MOTOMAN MH12 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_MOTOMAN_MH3F returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   motoman=load_robot('motoman', 'mh12');
%   q = [0 0 0 0 0 0];	
%   T = directkinematic(motoman, q);
%   %Call the inversekinematic for this robot
%   qinv = inversekinematic(motoman, T);
...
% Copyright (C) 2012, by Juan Alejandro And�jar Cuenca & Israel Mira Ant�n
%
...
function q = inversekinematic_MH12(robot, T)
