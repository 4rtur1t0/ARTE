%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_HP20D_6(robot, T)	
%   Solves the inverse kinematic problem for the MOTOMAN HP20D-6 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_HP20D_6 returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   robot=load_robot('MOTOMAN', 'HP20D-6');
%   q = [0 0 0 0 0 0];	
...
%   
%   Author: Pilar Pardo Millá y Adrián Juárez Serrano
...
function q = inversekinematic_HP20D_6(robot, T)
...
%case, the joint ranges from 60ï¿½ to -219ï¿½, thus, the typical normalizing
