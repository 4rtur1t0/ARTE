...
robot.name= 'MOTOMAN_ES165RD_II';

robot.DH.theta= '[q(1)    q(2)    q(3)     q(4)     q(5)   q(6)]';
robot.DH.d=     '[0.45     0      0      1.225        0       0.225]';
robot.DH.a=      '[0.74    1.15   0.25      0          0           0]';
robot.DH.alpha= '[pi/2      0      pi/2      pi/2     -pi/2         0]';

robot.J=[];
robot.directkinematic_fn = 'directkinematic(robot, q)';
robot.inversekinematic_fn='inversekinematic_MOTOMAN_ES165RD_II(robot,T)';
...
robot.maxangle =[-pi pi; %Axis 1, minimum, maximum
                deg2rad(-80) deg2rad(130); %Axis 2, minimum, maximum
                deg2rad(-0) deg2rad(78); %Axis 3
...
robot.velmax = [deg2rad(105); %Axis 1, rad/s
                deg2rad(105); %Axis 2, rad/s
                deg2rad(105); %Axis 3, rad/s
...
robot.graphical.color = [43 191 255]./255;
%for transparency
...
%link masses (kg)
robot.dynamics.masses=[459 496 276 187 46 46];
