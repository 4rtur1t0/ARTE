...
%   KUKA KR 160 R1570 nano-C.
%
%      Autores: 
%           Abiel Carrión Bailén    
%           Pablo Vicente Vidal     
%           Ramón Fontelles Congost 
%   email:  pablo.vicente@goumh.umh.es      date:   Feb. 2020
...
robot.name= 'KUKA KR 160 R1570 nanoC';

robot.DH.theta= '[q(1)  	q(2)-pi/2   q(3)    q(4)    q(5)    q(6)]';
robot.DH.d=     '[0.5       0           0       -0.71   0       -0.215]';
robot.DH.a=     '[0.250     0.61        -0.07   0       0       0]';
robot.DH.alpha= '[-pi/2     0           pi/2    -pi/2   pi/2    0]';
robot.J=[];


robot.inversekinematic_fn = 'inversekinematic_kuka_kr160_r1570_nanoC(robot, T)';
...
robot.maxangle =[(-180) (180); %Axis 1, minimum, maximum
                (-145) (45);   %Axis 2, minimum, maximum
                (-130) (145);  %Axis 3
                (-350) (350);  %Axis 4:
                (-120) (120);  %Axis 5
...
robot.velmax = [deg2rad(123); %Axis 1, rad/s
                deg2rad(114); %Axis 2, rad/s
                deg2rad(86); %Axis 3, rad/s
                deg2rad(179); %Axis 4, rad/s
                deg2rad(172); %Axis 5, rad/s
                deg2rad(220)];%Axis 6, rad/s
