%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_KUKA_KR60_3(robot, T)	
%   Solves the inverse kinematic problem for the KUKA KR60_3 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_KUKA_KR60_3 returns 8 possible solutions, thus,
...
function q = inversekinematic_kuka_kr60_3(robot, T)
