...
robot.name= 'KR5_2ARC_HW';

%Path where everything is stored for this robot
robot.path = 'robots/kuka/KR5_2ARC_HW';

robot.DH.theta= '[  q(1)  q(2)-(pi/2)     q(3)    q(4)    q(5)   q(6)]';
robot.DH.d='[       0.4     0           0       0.62   0    0.2]';
robot.DH.a='[       0.18   0.6         0.170    0       0      0]';
robot.DH.alpha= '[  -pi/2   0          -pi/2    pi/2    -pi/2   0]';
robot.J=[];

robot.inversekinematic_fn = 'inversekinematic_kuka_kr5_2arc_HW(robot, T)';
...
robot.maxangle =[deg2rad(-155) deg2rad(155); %Axis 1, minimum, maximum
                ...
                deg2rad(-200) deg2rad(80); %Axis 3
                deg2rad(-175) deg2rad(175); %Axis 4: Unlimited (400� default)
...
robot.graphical.color = [255 51 0]./255;
%for transparency
