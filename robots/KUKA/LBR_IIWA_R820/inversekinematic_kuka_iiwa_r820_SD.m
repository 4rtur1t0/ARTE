%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_KUKA_KR30_3(robot, T)	
...
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_KUKA_KR30_3 returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   robot=load_robot('kuka', 'KUKA_KR30_3');
%   q = [0 0 0 0 0 0];	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function q = inversekinematic_kuka_iiwa_r820(robot, T)
...
q = [q1+pi   q1+pi   q1+pi   q1+pi       q1   q1   q1   q1;   
