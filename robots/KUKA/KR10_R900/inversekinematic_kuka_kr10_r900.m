%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_KUKA_KR10_R900(robot, T)	
...
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_KUKA_KR10_R900_ARC_HW returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   robot=load_robot('kuka', 'KUKA_KR10_R900');
%   q = [0 0 0 0 0 0];	
...
% Author: Ramón David Sánchez Munuera
%         Daniel Caparrós Hernández
...
function q = inversekinematic_kuka_kr10_r900(robot, T)
