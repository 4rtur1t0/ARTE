...
robot.name= 'KR10_R900';

%Path where everything is stored for this robot
%robot.path = 'robots/kuka/KR10_R900';
  
%DH 
robot.DH.theta= '[ q(1) q(2)-pi/2 q(3) q(4) q(5) q(6)+pi]';
robot.DH.d='     [ 0.400 0 0 0.420 0 0.08]';
robot.DH.a='     [ 0.025 0.455 0.035 0 0 0]';
...
robot.inversekinematic_fn = 'inversekinematic_kuka_kr10_r900(robot, T)';
...
%link masses (kg)
robot.dynamics.masses=[4.18 5.42 3.01 2 0.5 0.3];
