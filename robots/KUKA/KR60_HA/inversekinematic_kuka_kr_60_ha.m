%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_KUKA_KR_60_HA(robot, T)	
%   Solves the inverse kinematic problem for the KUKA KR 60 HA robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_KUKA_KR_60_HA returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   robot=load_robot('KUKA', 'KR_60_HA');
%   q = [0 0 0 0 0 0];	
...
% Libreria ARTE
% Authors: 
% Ricardo Nieto Rodriguez, 
% Antonio Andreu Perez,
% Rodrigo Garcia Abenza
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function q = inversekinematic_kuka_kr_60_ha(robot, T)
