...
robot.DH.d='[0.335 0 0 -0.405 0 -0.080]';
robot.DH.a='[0.075 0.365 0.090 0 0 0]';
robot.DH.alpha= '[-pi/2 0 pi/2 -pi/2 pi/2 pi]';
robot.J=[];
robot.name= 'KUKA_KR5_sixx_R850';

robot.inversekinematic_fn = 'inversekinematic_kuka_kr5_sixx_r850(robot, T)';
