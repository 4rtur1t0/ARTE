%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Q = INVERSEKINEMATIC_KUKA_KR10_R1100_sixx(robot, T)	
%   Solves the inverse kinematic problem for the KUKA KR10 R900 robot
%   where:
%   robot stores the robot parameters.
%   T is an homogeneous transform that specifies the position/orientation
%   of the end effector.
%
%   A call to Q=INVERSEKINEMATIC_KUKA_KR10_R1100_sixx_ARC_HW returns 8 possible solutions, thus,
%   Q is a 6x8 matrix where each column stores 6 feasible joint values.
%
%   
%   Example code:
%
%   robot=load_robot('kuka', 'KUKA_KR10_R1100_sixx');
%   q = [0 0 0 0 0 0];	
...
% Author:    María Flores Tenza
%            Vicente Zaragoza Rodriguez
...
function q = inversekinematic_kuka_kr10_r1100_sixx(robot, T)
