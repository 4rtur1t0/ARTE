...
%   Mitsubishi rv_2aj robot with 5DOF.
%
%   Authors: Arturo Gil, Sandino Torres
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.name='Mitsubishi RV-2aj 5DOF robotic arm';


%kinematic data
robot.DH.theta= '[q(1) q(2) q(3) q(4) q(5)]';
robot.DH.d='[0.3 0 0 0 0.072]';
robot.DH.a='[0 0.280 0.100 0 0 0]';
...
robot.inversekinematic_fn = 'inversekinematic_rv_2aj(robot, T)';
