...
%   Mitsubishi RV-7F robot with 6DOF.
%
%   Authors: Antonio Vidal Civera
%            Adrián Navarro Rico
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
robot.name='Mitsubishi_rv-7f';

%Path where everything is stored for this robot
robot.path = 'robots/mitsubishi/rv-7f';
...
robot.inversekinematic_fn = 'inversekinematic_rv_7f(robot, T)';
