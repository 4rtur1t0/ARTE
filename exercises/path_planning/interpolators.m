...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Exercise 1:
%   Plan a joint trajectory from q1 to q2 using a linear interpolator.
%   The movement must be performed at a constant speed of 2 rad/s.
%   Go from q1=0 to q2=1.8 rad
%   q=[0 1.8];
%
%   a) Complete the function  first_order in order to return the required
%   data.
%   
...
% A)COMPLETE THE first_order function (below)
[q_t, qd_t, time, k]=first_order([q(1) q(2)], [t(1) t(2)], delta_t);

% B) PLOT THE RESULTS 


%WRITE the EQUATION on screen as:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Exercise 4:
%   Use a 4th order planner to compute a trapezoid acceleration profile.
...
%   A) THE FIRST ACCELERATION SECTOR IN THE TRAPEZOIDAL PROFILE is given as
%   an example to the student.
%   B) COMPLETE THE SECOND AND THIRD SECTORS AT CONSTANT SPEED AND CONTANT
%   DECELERATION.
...
%B)TODO, complete the two remaining sectors
...
%
%   This exercise is presented as SOLVED as an example for students.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%TODO complete with your method
