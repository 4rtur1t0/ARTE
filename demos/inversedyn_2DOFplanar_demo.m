...
%gravity acting on x0
g0=[-9.81 0 0]';

%gravity acting on y0
g1=[0 -9.81 0]';

%gravity acting on z0
g2=[0  0 -9.81]';
...
tau = inversedynamic(planar, q1, [0 0], [0 0], g2, [0 0 0 0 0 0])
...
tau = inversedynamic(planar, q1, [0 0], [0 0], g1, [0 0 0 0 0 0])
disp('press any key to continue')
pause
...
tau = inversedynamic(planar, q1, [0 0], [0 0], g2, [1 0 1 1 1 0])
disp('press any key to continue')
pause
...
tau = inversedynamic(planar, q2, [1 1], [1 1], g2, [0 1 0 0 0 1])
