%Simulación únicamente del proyectil, introducir un punto objetivo en Po
%para probar el algoritmo. Para variar los parámetros de la simulación
%(coeficiente de rozamiento, masa del proyectil...) ir a la función
%think(), más abajo.


function Simulacion_proyectil
    Po = [327; 410; 300]; %%%%%%%%%%%%%%%%PUNTO OBJETIVO%%%%%%%%%%%%%%%%%%%%%%%%5
