...
%load 3dof planar robot
%the parameters are loaded from robots/example/3dofplanar/parameters.m
planar=load_robot('example', '3dofplanar');
...
tau = inversedynamic(planar, q1, [0 0 0], [0 0 0], [0 0 9.81]', [1 0 1 1 1 0]')
...
tau = inversedynamic(planar, q1, [0 0 0], [0 0 0], [0 0 9.81]', [0 1 0 0 0 0]')
%draw the robot at this position
drawrobot3d(planar,q1)
disp('press any key to continue')
pause
...
tau = inversedynamic(planar, q2, [1 1 1], [1 1 1], [0 0 9.81]', [0 0 0 0 0 0]')
...
tau = inversedynamic(planar, q1, [0 0 0], [0 0 0], [0 9.81 0]', [0 0 0 0 0 0]')
